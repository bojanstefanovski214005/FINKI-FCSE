...
# dimenzii
DIMENSION = 2
# 5 sekundi na pocetok
TIMEOUT = 5  # seconds before game over if no button is pushed.
# brojac za izmeni na lista
patternChanges = 0


def main():
    # dodavanje na promenlivi
    ...
    while True:  # main game loop
        ...
        if not waitingForInput:
            ...
            # +1 na brojacot za izmeni na listata
            patternChanges += 1

            # Proverka dali borjot e deliv so 10
            ...
            # proverka dali treba da se zgolemi tabelata
            ...
            # lista so obraten redosled
            reversedPattern = list(reversed(pattern))

            # proverka na nova lista
...
def drawButtons():
    ...
    # Zgolemuvanje na brojot na kopcinja
    if DIMENSION > 2:
